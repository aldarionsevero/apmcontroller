...
public:
	Control() {
		...
		/* Non linear part */
		nonlin_subscriber_ = node_handle_.subscribe("nonlinearity", 1,
				&Control::nonlinCallback, this);
		nonlinx = 0;
		nonliny = 0;
		nonlinz = 0;
		xoff = 0;
		...
		gain_subscriber_ = node_handle_.subscribe("gains", 1,
				&Control::gainCallback, this);
	}
